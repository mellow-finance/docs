...
The stRATEGY Vault offered boosted Mellow Points for the first 4 weeks after launch (October 1-29, 2025). That boost period has concluded:

* During the boost window, every $1 of value in strETH earned 0.00075 Mellow Points per hour.

Since the boost period ended, the rate has been:
