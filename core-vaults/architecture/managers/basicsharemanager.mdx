...
This contract is intended for setups where shares are not tokenized onchain as ERC20s but are still tracked internally using the ERC20Upgradeable storage schema.
