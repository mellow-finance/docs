---
title: "Deployments"
description: "Contract addresses for earnETH, earnUSD, earnUSDc and earnUSDe across Ethereum, Base, Plasma and Mantle, plus the multisig roles governing all Lido Earn vaults."
---

Contract addresses for the Lido Earn vaults and the underlying vaults of EarnUSD. The roles listed at the bottom govern all Lido Earn vaults and use the same addresses on every chain.
...
<AccordionGroup>
  ...
  <Accordion title="earnUSDc – Ethereum">
    | Contract | Address |
    | --- | --- |
  ...
  <Accordion title="earnUSDe – Ethereum">
    | Contract | Address |
    | --- | --- |
  ...
  <Accordion title="earnUSDe – Plasma">
    | Contract | Address |
    | --- | --- |
  ...
  <Accordion title="earnUSDe – Mantle">
    | Contract | Address |
    | --- | --- |
