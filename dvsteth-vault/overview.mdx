---
title: "Overview"
description: "Legacy: Wrapped liquid staking token powered by Lido wstETH with DVT incentive layer. Covers Obol and SSV incentive calculation, claiming process, withdrawal mechanics, and FAQ."
---

<Info>
**Legacy architecture.** DVstETH is an earlier generation of Mellow vault infrastructure, documented for existing deployments. [Core Vaults](/core-vaults/overview) are Mellow's current vault architecture.
</Info>
