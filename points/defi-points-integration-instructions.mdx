...
description: "Legacy: Technical integration guide with TypeScript interfaces: getContracts, getUserShares, getBalances, getDeFiPools. Includes full Zircuit example implementation and all type definitions."
---
